...
public class CustomTwilioVideoView extends View implements LifecycleEventListener {
    ...
    public CustomTwilioVideoView(ThemedReactContext context) {
        ...
        themedReactContext.registerReceiver(myNoisyAudioStreamReceiver, intentFilter);
    }
    ...
    public void connectToRoomWrapper(String roomName, String accessToken, boolean videoEnabled) {
        Log.i("CustomTwilioVideoView", "connectToRoomWrapper");
    ...
    public void setSpeakerphone(boolean stat){
        audioManager.setSpeakerphoneOn(stat);
    }
    ...
    // ===== NEW ==========================================================================
    public void elevator(final String fileName) {
        Log.i("CustomTwilioVideoView", "elevator " + fileName );
        this.mediaPlayer = new MediaPlayer();
        try {
            AssetFileDescriptor descriptor = this.themedReactContext.getAssets().openFd(fileName.replace("asset:/", ""));
            ...
            Log.e("CustomTwilioVideoView", "Exception", e);
        }
    }
    public void elevatorResume(){
        mediaPlayer.start();
    }
    public void elevatorPause(){
        mediaPlayer.pause();
